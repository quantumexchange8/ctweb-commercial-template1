...
<!--Start Financial Projections area-->
<section id="single-service-area" class="financial-projections-area">
    <div class="container">
        <div class="row">
                        ...
                        <div class="top-content">
                            ...
                            <div class="col-lg-7 col-md-12">
                                <div class="img-holder">
                                    <img src="images/services/service-single/financial-projections.jpg" alt="Awesome Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="page-link">
                            ...
                            <li>
                                <a class="active" href="/financial_Projections">
...
<!--End Financial Projections area-->
@endsection