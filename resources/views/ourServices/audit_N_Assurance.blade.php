...
<!--Start Audit Assurance area-->
<section id="single-service-area" class="audit-assurance-area">
    <div class="container">
        <div class="row">
                        ...
                        <div class="top-content">
                            ...
                            <div class="col-lg-7 col-md-12">
                                <div class="img-holder">
                                    <img src="images/services/service-single/audit-assurance.jpg" alt="Awesome Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="page-link">
                            ...
                            <li>
                                <a class="active" href="/audit_N_Assurance">
                                    Audit & Assurance
                                    <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                </a>
                            </li>
